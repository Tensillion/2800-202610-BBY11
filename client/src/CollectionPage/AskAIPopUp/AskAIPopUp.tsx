...
export default function AskAIPopUp({ plantInfo }: AskAIPopUpProps) {
	...
	const submitQuestion = async (rawQuestion: string, clearAfterStart = false) => {
		...
		<div className="ask-ai">
			{isOpen ?
				<div className="ask-ai-panel" role="dialog" aria-label="Ask AI">
					...
					<p className="ask-ai-subtitle">Choose a preset question or ask your own.</p>
					...
					{isCooldown ?
						<p className="ask-ai-note">Please wait a few seconds before asking again.</p>
					:	null}
					{error ?
						<p className="ask-ai-error">{error}</p>
					:	null}
					{answer ?
